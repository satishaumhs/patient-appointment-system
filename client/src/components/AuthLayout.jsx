...
const AuthLayout = ({ title, subtitle, children }) => (
  <div className="min-h-[calc(100vh-73px)] flex">
    <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-teal-600 via-teal-700 to-cyan-900 text-white flex-col justify-center px-14">
    ...
    <div className="flex-1 flex items-start lg:items-center justify-center px-6 py-10 lg:py-16 bg-slate-50">
